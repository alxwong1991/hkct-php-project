...
$get_all_req_sender = $frnd_obj->request_notification($_SESSION['userid'], true);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="profile_container">
        ...
        <div class="inner_profile">
            <div class="img">
                <img src="./upload/profile<?php echo $user_data->usersId; ?>.jpg" alt="Profile image">
            </div>
        ...
        <nav>
            <ul>
                ...
                <li><a href="notifications.php" rel="noopener noreferrer" class="active">Requests<span class="badge 
                <?php
                if ($get_req_num > 0) {
                    echo 'redBadge';
                }
                ...
                <li><a href="../php/logout.inc.php" rel="noopener noreferrer">Logout</a></li>
            </ul>
        </nav>
        <div class="all_users">
                ...
                if ($get_req_num > 0) {
                    foreach ($get_all_req_sender as $row) {
                        echo '<div class="user_box">
                                <div class="user_img"><img src="./upload/profile' . $row->sender . '.jpg" alt="Profile image"></div>
