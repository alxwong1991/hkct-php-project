...
<body style="background-color:powderblue;">>
    <div class="profile_container">
        ...
        <div class="inner_profile">
            <div class="img">
                <?php
                echo'<img src="./upload/profile'.$user_data->usersId.'" alt="Profile image">';
                ?>
            ...
            <ul>
                ...
                <li><a href="friends.php" rel="noopener noreferrer">Friends<span class="badge"><?php echo $get_frnd_num;?>
            </span></a></li>
