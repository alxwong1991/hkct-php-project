...
--
-- Host: localhost
-- Generation Time: May 05, 2022 at 04:37 PM
...
--
INSERT INTO
  `nosurvey` (`Exitid`, `usersid`, `Qid`, `leavingtime`)
VALUES
...
--
INSERT INTO
  `options` (`id`, `qno`, `correct`, `choices`)
VALUES
  (1, 1, 0, 'Yes'),
  (2, 1, 2, 'No'),
  (3, 2, 0, 'Anime'),
...
VALUES
  (
    1,
    'Balenciaga',
    'Shopping Phone holder bag',
    'A new season may be here, but the frenzy for logomania is far from over. At the helm of the trend, Balenciaga continues to offer branded styles.\r\nMade in Italy',
    'One Size available',
    'unique',
    '8000.00',
    '\"images/p1.jpg\"',
  ...
  (
    2,
    'Balenciaga',
    'logo print crossbody bag',
    'It is no surprise that anything Balenciaga conjures up rises to cult status. \r\nMade in Italy',
    'One Size available',
    'unique',
    '7400.00',
    '\"images/p2.jpg\"',
  ...
  (
    3,
    'Gucci',
    'Gucci Off The Grid mini bag',
    'Gucci knows that travelling light means leaving behind a lighter footprint too.\r\nMade in Italy',
    'One Size available',
    'unique',
    '7800.00',
    '\"images/p3.jpg\"',
  ...
  (
    4,
    'Givenchy',
    'Antigona U vertical shoulder bag',
    'Made in Italy',
    'One Size available',
    'unique',
    '8700.00',
  ...
  (
    5,
    'Salvatore Ferragamo',
    'Gancini leather wallet-on-chain',
    'Designed to hold a phone, this Salvatore Ferragamo mini bag is detailed with the brand\'s signature Gancini plaque in antique-gold, matched by the thin chain-link strap.\r\nMade in United Kingdom',
    'One Size available',
    'unique',
    '3600.00',
    '\"images/p6.jpg\"\r\n',
  ...
  (
    6,
    'Balenciaga',
    'Shopping iPhone holder',
    'Balenciaga downscales its iconic Shopping tote to present this iPhone holder. This compact accessory is crafted from croc-embossed leather and is detailed with a contrasting logo to the front. Made in Italy',
    'One Size available',
    'unique',
    '8500.00',
    '\"images/p5.jpg\"',
  ...
  (
    7,
    'Prada',
    'hammered triangle-panel mini bag',
    'Made up of an assortment of triangular panels, this hammered leather mini bag from Prada is dressed in a striking silver hue.\r\nMade in United Kingdom',
    'One Size available',
    'unique',
    '18400.00',
    '\"images/p7.jpg\"\r\n',
...
VALUES
  ...
  (
    3,
    'Do you want to test your knowledge about it?'
  ),
  (4, '「2符」不包含哪個選項？'),
  (5, '「特殊流局」不包含哪個選項？');
